...
let storyBank =  [
    ...
    Story(title: "Star Wars", logline: "A courageous but naive farmer must trust a mysterious force before a sinister lord destroys a rebellion", writer: "George Lucas", year: "1977", fact: "George Lucas based the struture of the narrative on Joseph Campbell’s monomyth theories in The Hero with a Thousand Faces", symbol: "\u{e033}"),
    ...
    Story(title: "The Simpsons Movie", logline: "A lazy but caring oaf must diffuse a suspended bomb before a power mad environmentalist destroys a dome", writer: "James L Brooks, Matt Groening, Al Jean, Ian Maxtone-Graham, George Meyer, David Mirkin, Mike Reiss, Mike Scully, Matt Selman, John Swartzwelder, Jon Vitti", year: "2007", fact: "The script was rewritten 153 times by a team of 11 writers", symbol: "\u{f706}"),
    ...
    Story(title: "The Nightmare Before Christmas", logline: "A well-meaning but terrifying skeleton must rekindle a spooky passion before a gambling boogeyman kills Santa.", writer: "Tim Burton, Michael McDowell", year: "1993", fact: "Burton was inspired to write the original poem after he saw a store replacing its Halloween display with Christmas products", symbol: "\u{f786}"),
    Story(title: "Bill & Ted\u{2019}s Excellent Adventure", logline: "A humurous but moronic rock band must complete an outstanding odyssey before a strict father exiles a son", writer: "Chris Matheson, Ed Solomon", year: "1989", fact: "The script was written by hand in four days", symbol: "\u{f8be}")
